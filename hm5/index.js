...
// в response должны быть реализованы методы json(), text() и желательно blob()
...
// Документация по FileReader - https://developer.mozilla.org/ru/docs/Web/API/FileReader и 
